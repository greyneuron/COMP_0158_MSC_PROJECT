...
if [[ "$platform" == "mac" ]]; then 
    ...
    corpus_file='/Users/patrick/dev/ucl/word2vec/comp_0158_msc_project/data/models/word2vec_sentences.pkl'
...
# call python
python3 "${code_dir}/run_w2v_batch.py" --model_type skip --ws 2 --mc 1 --corpus_file="${corpus_file}" --output_dir="$output_dir"
