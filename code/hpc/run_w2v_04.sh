...
python3 "${code_dir}/w2v_batch.py" --model_type skip --mc 8 --ws 3 --corpus_file="${corpus_file}" --output_dir="$output_dir"
python3 "${code_dir}/w2v_batch.py" --model_type skip --mc 8 --ws 5 --corpus_file="${corpus_file}" --output_dir="$output_dir"
python3 "${code_dir}/w2v_batch.py" --model_type skip --mc 8 --ws 8 --corpus_file="${corpus_file}" --output_dir="$output_dir"
python3 "${code_dir}/w2v_batch.py" --model_type skip --mc 8 --ws 13 --corpus_file="${corpus_file}" --output_dir="$output_dir"
python3 "${code_dir}/w2v_batch.py" --model_type skip --mc 8 --ws 21 --corpus_file="${corpus_file}" --output_dir="$output_dir"
python3 "${code_dir}/w2v_batch.py" --model_type skip --mc 8 --ws 44 --corpus_file="${corpus_file}" --output_dir="$output_dir"
