...
if __name__ == '__main__':
    ...
    for model_info in models_info:
        ...
        #
        print(f"\nCreating distance matrices for model {model_name} located at {model_path}")
        ...
        for dist_type, w2v_distance_matrix in w2v_matrices.items():
            ...
            print(f" - Original matrix shapes. \t w2v: {w2v_distance_matrix_fl.shape} evo : {evo_dist_matrix.shape}")
            try:
