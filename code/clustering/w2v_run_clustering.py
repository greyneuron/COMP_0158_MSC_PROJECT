...
# creates and runs random forest generators with varying depths
#
def run_kmeans(X, Y, pfam_ids, clan_dict, model_name, output_dir):
    ...
    for k in ks:
        ...
        # cluster dict  = predicted clusters
        # clan_dict     = actual clusters 
...
if __name__ == '__main__':
    ...
    for model_name in model_names:
        ...
        pfams, clans, clan_dict = w2v_clan_utils.get_pfam_clans_for_model(model_name, model_path, 2)
        ...
        run_kmeans(X, Y, pfams, clan_dict, model_name, output_dir)
