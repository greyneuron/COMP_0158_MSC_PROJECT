...
Pre-Corpus : Combined Tokens
- Note that this is the one that was re-created after I noticed that the inner join has missed some proteins
...
- based upon uniref100_e_tokens_combined_20240910.dat but doesn't have rules around gap distance
- 46,554,318 lines


- ** Created Fri Sept 20 with a minimum gap of 50 
- uniref100_e_corpus_gap_50_20240920_1643.txt
- based upon uniref100_e_tokens_combined_20240910.dat but has rules around gap distance - gap dist of 50
- 37,721,172 lines
- created in : 294.23s
- I have checked it and it did what it should
...
-----------------------------------------
            Models
-----------------------------------------
- Recreated all models using uniref100_e_corpus_20240910.dat including skipgram and cbow
- May have left some higher dimensional ones out
- This was between Sept 10 and 12

- Recreated a seclection using : uniref100_e_corpus_gap_50_20240920_1643.txt
